...
export class createtableposgres1564994770262 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "badge_id" character varying NOT NULL, "department" character varying NOT NULL, "extension" character varying NOT NULL, "email" character varying NOT NULL, "is_security" boolean NOT NULL, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "requests" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "ic" character varying NOT NULL, "phone" character varying NOT NULL, "car_plate" character varying, "visit_from" TIMESTAMP NOT NULL, "visit_to" TIMESTAMP NOT NULL, "purpose" character varying NOT NULL, "status" character varying NOT NULL, "primary_contact_id" integer NOT NULL, "primary_contact_phone" character varying NOT NULL, "alternative_contact_id" integer, "alternative_contact_phone" character varying, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_0428f484e96f9e6a55955f29b5f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "registrations" ("id" SERIAL NOT NULL, "request_id" integer NOT NULL, "checkin_at" TIMESTAMP NOT NULL, "checkout_at" TIMESTAMP, "checkin_by" integer NOT NULL, "escort_by" integer NOT NULL, "belongings" character varying, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, "updated_by" integer NOT NULL, CONSTRAINT "REL_5cf271a50a3ddb6a81fb49adc2" UNIQUE ("request_id"), CONSTRAINT "PK_6013e724d7b22929da9cd7282d1" PRIMARY KEY ("id"))`);
