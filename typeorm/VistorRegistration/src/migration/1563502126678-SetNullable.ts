...
export class SetNullable1563502126678 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "requests" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255) NOT NULL, "ic" nvarchar(255) NOT NULL, "phone" nvarchar(255) NOT NULL, "car_plate" nvarchar(255), "visit_from" datetime NOT NULL, "visit_to" datetime NOT NULL, "purpose" nvarchar(255) NOT NULL, "department" nvarchar(255) NOT NULL, "status" nvarchar(255) NOT NULL, "primary_contact_id" int NOT NULL, "alternative_contact_id" int, "created_at" datetime NOT NULL, "created_by" int NOT NULL, "updated_at" datetime, CONSTRAINT "PK_0428f484e96f9e6a55955f29b5f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "registrations" ("id" int NOT NULL IDENTITY(1,1), "request_id" int NOT NULL, "checkin_at" datetime NOT NULL, "checkout_at" datetime, "checkin_by" int NOT NULL, "escort_by" int NOT NULL, "belongings" nvarchar(255), "created_at" datetime NOT NULL, "created_by" int NOT NULL, "updated_at" datetime, "updated_by" int, CONSTRAINT "PK_6013e724d7b22929da9cd7282d1" PRIMARY KEY ("id"))`);
